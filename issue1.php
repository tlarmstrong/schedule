		...
		<div class="bodyWrap">
	            ...
	            <button class="btn btn-lg btn-primary btn-block" type="submit">Schedule it!</button>
				  ...
				  <div class="col-md-4 issue">
				  	<div class="topStrip">
				  		...
				  		<p><strong>CS230 Object Oriented Programming</strong></br>
  						...
  						<p>Number of students enrolled: <strong>20</strong></br>
  							Students with conflicts: <strong>6</strong></p>
						  ...
						  <dt>Sally Norman</dt>
							  <dd>Major: Biology</dd>
							  <dd>Conflict: BIO103</dd>
							  <dd>Advising Contact: <a class="link" href="mailto:someone@example.com">Gary Johnson</a></dd>
							  </br>
						  <dt>Jane Doe</dt>
							  <dd>Major: Marketing</dd>
							  <dd>Conflict: IS432 Data Mining</dd>
							  <dd>Advising Contact: <a class="link" href="mailto:someone@example.com">Mary Blackwell</a></dd>
							  </br>
						  <dt>Aviva Masters</dt>
							  <dd>Major: Computer Science</dd>
							  <dd>Conflict: CS330 HCI II</dd>
            ...
            <div class="col-md-4 issue">
				  	<div class="topStrip">
						...
						<a class="btn btn-lg btn-primary btn-block" href="issue1b.php">Done!</a>
  					</div>
